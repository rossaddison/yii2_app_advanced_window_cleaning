...
<?php echo $form->field($model, 'housenumber_ids',[
    ...
    'hintOptions' => ['class' => 'form-text text-muted text-left']])->widget(DualListbox::className(),[
        ...
        'clientOptions' => [
            ...
            'nonSelectedListLabel' => Yii::t('app', 'Available'),
            
            'selectedListLabel' => Yii::t('app', 'Selected'),
            'filterTextClear' => Yii::t('app', 'Show all'),
            'filterPlaceHolder' => Yii::t('app', 'Filter'),
            'moveSelectedLabel' => Yii::t('app', 'Move selected'),
            'moveAllLabel' => Yii::t('app', 'Move all'),
            'removeSelectedLabel' => Yii::t('app', 'Remove selected'),
            'removeAllLabel' => Yii::t('app', 'Remove all'),
            'infoText' => Yii::t('app', "Showing all {0}"),
            'infoTextFiltered' => Yii::t('app', "<span class='text-dark bg-warning'>Filtered</span> {0} from {1}"),
            'infoTextEmpty' => Yii::t('app', 'Empty list'),
            'btnMoveText' => '&rsaquo;',
