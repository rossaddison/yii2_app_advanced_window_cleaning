            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[read_only_toggle]" data-bs-toggle='tooltip' title="<?= Yii::t('app','Toggle to prevent the invoice from being updated once it has been sent, viewed, or paid.'); ?>">
                                <?= Utilities::trans('set_to_read_only').str_repeat("&nbsp;", 2). Icon::show('info-circle', ['framework' => Icon::FAS]); ?>
                            </label>
                            <select name="settings[read_only_toggle]" id="settings[read_only_toggle]" class="form-control">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="settings[mark_invoices_sent_pdf]" data-bs-toggle="tooltip" title="<?= Yii::t('app','Customers can only view invoices online that are marked as sent. Pdf archiving occurs automatically when emailing and invoices are automatically marked as sent. If we choose not to email, by default, invoices must still be marked as sent so they can be viewed by customers. So instead of emailing them, just archive them by pdf generation via Sales Invoices and the user will be able to view them online. This setting should be set to No if emailing is the default.'); ?>">
                                <?= Utilities::trans('mark_invoices_sent_pdf').str_repeat(" ", 2). Icon::show('info-circle', ['framework' => Icon::FAS]); ?>
                            </label>
