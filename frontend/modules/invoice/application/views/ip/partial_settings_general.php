                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="settings[default_language]" id="settings[default_language]" class="input-sm form-control">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="settings[currency_code]" data-toggle='tooltip' title="<?= Yii::t('app','Gateway Currency Codes.'); ?>">
                                <?= Utilities::trans('currency_code'). str_repeat("&nbsp;", 2). Icon::show('info-circle', ['framework' => Icon::FAS]); ?>
                            </label>
